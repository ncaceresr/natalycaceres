...
$contenido->idclasificaciones=2;
$contenido->imagen= "";
$contenido->titulo= '¡Hola a todos!';
$contenido->subtitulo= 'pruebas2';
...
<div class=container>
    <div class="card  w-75 align-item: center">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-3">
                    <label  for="clasificacion" class=label-primary name="clasificacion">Clasificación</label>
                </div>
                <div class="col-9">
